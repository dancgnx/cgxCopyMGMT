...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'cgxCopyMGMT')
    custom_group.add_argument("--s_element", help="Name of the element (claimed device) to copy from",
                              default=None, action="store",dest="s_element",required=True)
    custom_group.add_argument("--s_interface", help="Name of the interface to copy from",
                              default=None, action="store",dest="s_interface",required=True)
    custom_group.add_argument("--t_element", help="Name of the element (claimed device) to copy to",
                              default=None, action="store",dest="t_element")
    custom_group.add_argument("--t_interface", help="Name of the interface to copy to",
                              default=None, action="store",dest="t_interface")
    custom_group.add_argument("--list", help="list the current config of the Source device+interface",
